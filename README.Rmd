...
## How?!
 ...
 - You can cutomize the output adding `font`, `padding`, `rotate.min` and `rotate.max`.
 - You can use in your shiny apps like [here](http://r-shiny-apps.jkunst.com/d3wordcloud/) and [there](kangurostore.info)
...
## References
 - Yep I repeated myself (this is NOTDRY). There is a package with this functionality:  ([link](https://github.com/adymimos/rWordCloud)). Anyway I want add more features and options in this packages. 
